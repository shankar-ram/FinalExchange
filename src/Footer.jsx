...
<footer className=" text-lg-start  text-muted" >
    ...
    <div className="container text-md-start ">
      ...
      <div className="row ">
        ...
        <div style={{paddingRight:"2rem", paddingLeft:"2rem"}} className="col-lg-6 col-md-6 mt-5 ">
          ...
          <h5 className="text-uppercase fw-bold mb-4" style={{fontFamily:"Strasua"}}> AntEagle &nbsp;Exchange
          </h5>
          <p>
      ...
      <a  href="https://mobile.twitter.com/anteagle_"  target="_blank" className="me-4 text-reset">
        <img src={tw}></img>
      </a>
      ...
      <a href="https://t.me/anteagle" target="_blank" className="me-4 text-reset">
        ...
        <div style={{paddingRight:"2rem", paddingLeft:"2rem",paddingBottom:"2rem"}} className="col-lg-6  col-md-6 mt-5">
          ...
          <p className="contact"><img src={email}></img> support.exchange@anteagle.tech</p>
    ...
    <div className="text-center p-4" style={{backgroundColor:"rgba(0, 0, 0, 0.05)"}}>
     Copyright ©
    <a className="text-reset fw-bolder" to="">Opulentia Cresco Private Limited</a>
  </div>
