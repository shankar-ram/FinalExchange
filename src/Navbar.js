   ...
   return(
     ...
     <div>
      <Navbar fixed="top"  dark expand="md" style={{padding:"1% 3% 2%",backgroundColor:" #200F21"}}>
        <NavbarBrand href="/" style={{fontFamily:"Strasua"}}> <img src={logo}  class="img-fluid img-thumbnail rounded-circle" style={{width:"75px"}}></img> AntEagle&nbsp; Exchange<br/><p style={{fontSize:"15px",marginLeft:"5rem",marginTop:"-1.8rem",fontFamily:"sans-serif"}}>By the traders for the traders</p></NavbarBrand>
